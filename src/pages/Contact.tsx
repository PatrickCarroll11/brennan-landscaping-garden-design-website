...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const phone = "353614567890";
    const firstName = "Ciara";
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-6 mb-10">
                <a href="tel:0614567890" className="flex items-center gap-3 group">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">061 456 7890</p>
                  </div>
                </a>
                <a href="mailto:ciara@brennanlandscaping.ie" className="flex items-center gap-3 group">
                  <div className="w-10 h-10 rounded-lg bg-brand-green-light flex items-center justify-center group-hover:bg-primary group-hover:text-primary-foreground transition-colors">
                    <Mail className="h-5 w-5 text-primary group-hover:text-primary-foreground" />
                  </div>
                  <div>
                    <p className="text-sm text-muted-foreground">Email</p>
                    <p className="font-semibold">ciara@brennanlandscaping.ie</p>
                  </div>
                </a>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">Limerick, Ireland</p>
                  </div>
                </div>
              </div>
