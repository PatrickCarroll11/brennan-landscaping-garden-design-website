        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Why Choose Brennan Landscaping & Garden Design?
            </h2>
            <p className="text-muted-foreground mb-8 leading-relaxed">
              With a focus on creativity and sustainability, we deliver high-quality landscaping services that stand the test of time. Our experienced team is committed to bringing your outdoor vision to life.
            </p>
