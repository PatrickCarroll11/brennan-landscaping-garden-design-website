      ...
      <div className="relative container py-28 md:py-36">
        <div className="max-w-2xl">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-white leading-tight mb-6">
            Transform Your Outdoor,<br />Space with Us
          </h1>
          <p className="text-lg md:text-xl text-white/85 mb-10 leading-relaxed max-w-lg">
            Expert landscaping and garden design services in Limerick and beyond.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Button asChild size="lg" variant="outline" className="border-white/60 text-white hover:bg-white/10 font-semibold px-10 py-6 text-base">
              <a href="tel:0614567890" className="flex items-center gap-2">
